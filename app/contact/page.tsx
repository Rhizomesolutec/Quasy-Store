  ...
  return (
    <main className="relative w-full flex flex-col items-center">
        ...
        <div className="grid md:grid-cols-2 gap-12 md:gap-20">
          ...
          <RevealOnScroll delay={0.1} className="space-y-8">
            ...
            <div className="border border-white/[0.08] p-6 space-y-4">
              <h3 className="font-heading text-sm uppercase tracking-widest text-[#D8CFC0]">The Workshop</h3>
              <div className="font-sans text-sm text-[#D8CFC0]/60 space-y-1.5">
              ...
              <div className="flex gap-4 pt-2 border-t border-white/[0.06]">
                {SOCIALS.map((s) => (
                  <a
                    key={s.label}
                    href={s.href}
                    className="font-sans text-[10px] uppercase tracking-widest text-[#D8CFC0]/60 hover:text-[#8E1F1F] transition-colors"
                  >
                    {s.label}
                  </a>
                ))}
            ...
            {/* Map placeholder */}
            <div className="relative aspect-[4/3] border border-white/[0.08] bg-[#1a1a1a] overflow-hidden flex items-center justify-center">
              <div
              ...
              <div className="relative z-10 flex flex-col items-center gap-2 text-center px-6">
                <svg className="w-8 h-8 text-[#8E1F1F]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                </svg>
                <p className="font-sans text-[10px] uppercase tracking-widest text-[#D8CFC0]/40">Map preview unavailable</p>
              </div>
            </div>
          </RevealOnScroll>
        </div>
      ...
      <section className="w-full px-4 md:px-12 lg:px-24 py-20 max-w-3xl border-t border-white/[0.06]">
        <RevealOnScroll>
          <h2 className="font-heading text-2xl text-[#D8CFC0] text-center mb-10">Frequently Asked</h2>
