...
export default function NotFound() {
  return (
    <main className="relative w-full min-h-screen flex flex-col items-center justify-center px-6 text-center">
      ...
      <h1 className="font-heading text-7xl md:text-9xl text-[#D8CFC0] leading-none mb-4">404</h1>
      <Divider className="mx-auto mb-6" />
      <p className="font-sans text-sm md:text-base text-[#D8CFC0]/60 leading-relaxed max-w-md mb-10">
