  ...
  return (
    <main className="relative w-full flex flex-col items-center">
      ...
      <section className="relative w-full h-[60vh] min-h-[420px] flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-[#111111]/40 via-[#111111]/60 to-[#111111]" />
        <div className="relative z-10 max-w-3xl px-6 text-center flex flex-col items-center">
          ...
          <h1 className="font-heading text-5xl md:text-6xl text-[#D8CFC0] mb-6">{collection.name}</h1>
          <Divider className="mb-6" />
          <p className="font-sans text-sm md:text-base text-[#D8CFC0]/70 leading-relaxed max-w-xl">
