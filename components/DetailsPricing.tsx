    ...
    <section ref={sectionRef} className="w-full min-h-screen py-32 px-4 md:px-12 lg:px-24 flex flex-col items-center">
      <div className="max-w-6xl w-full">
        ...
        <div ref={addToRefs} className="text-center mb-32">
          ...
          <div className="w-24 h-[1px] bg-[#E50914] mx-auto mb-8" />
          <p className="font-sans text-lg text-[#F5F2EF]/70 max-w-2xl mx-auto leading-relaxed">
        ...
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-center mb-32">
          ...
          <div ref={addToRefs} className="w-full lg:w-1/2 flex flex-col justify-center">
            ...
            <p className="font-sans text-[#F5F2EF]/60 text-lg mb-8 leading-relaxed">
            ...
            <div className="flex items-end gap-6 border-b border-[#F5F2EF]/20 pb-6">
              <span className="font-sans text-3xl tracking-wider text-[#E50914]">
                ₹185.00
              </span>
              <span className="font-sans text-sm text-[#F5F2EF]/40 uppercase tracking-widest pb-1">
                Limited Edition
              </span>
            </div>
          </div>
        ...
        <div className="flex flex-col lg:flex-row-reverse gap-16 lg:gap-24 items-center">
          <div ref={addToRefs} className="relative w-full lg:w-1/2 aspect-[4/5] bg-black rounded-sm overflow-hidden shadow-2xl shadow-[#E50914]/10">
            <Image
