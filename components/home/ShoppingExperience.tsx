  ...
  return (
    <section className="w-full px-4 md:px-12 lg:px-24 py-24 md:py-32 border-t border-white/[0.05]">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 border border-[#222]">
          {EXPERIENCES.map((item, idx) => (
            <motion.div
              ...
              className="group bg-[#0a0a0c] border border-[#E50914]/50 p-8 md:p-10 transition-all duration-500 hover:border-[#E50914] retro-box-shadow relative"
            >
              <div className="flex items-center justify-between mb-5">
                <div
                  className="transition-transform duration-500 group-hover:scale-110 origin-left text-[#E50914]"
                >
                  {item.icon}
                </div>
                <span className="font-pixel text-[10px] font-bold text-[#E50914]">
                  0{idx + 1}
                </span>
              </div>
